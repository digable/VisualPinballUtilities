    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (g.IsServiceRunning)
            {
                ...
                if (mf != null && mf.Enabled) Functions.MoveFile.IsEnabled(mf, rp, g.LogFile);
                ...
                if (rs == null && ak == null && uk == null && mf == null)
                {
                    ...
                    Utilities.WriteToLogFile(Utilities.LoggingType.Warning, Utilities.ApplicationFunction.Global, details, g.LogFile);
                    details = null;
                }
